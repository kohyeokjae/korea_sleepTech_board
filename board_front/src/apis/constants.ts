...
// 게시글 단건 조회
const GET_BOARD_URL = (boardId: number | string) =>
  `${BOARD_MODULE_URL}/${boardId}`;

// 게시글 수정
const PUT_BOARD_URL = (boardId: number | string) =>
  `${BOARD_MODULE_URL}/${boardId}`;

// 게시글 삭제
const DELETE_BOARD_URL = (boardId: number | string) =>
  `${BOARD_MODULE_URL}/${boardId}`;

// 댓글 생성
const POST_COMMENT_URL = (boardId: number | string) =>
  `${BOARD_MODULE_URL}/${boardId}/comments`;

// 댓글 조회 (전체: 게시글 ID)
const GET_COMMENT_URL = (boardId: number | string) =>
  `${BOARD_MODULE_URL}/${boardId}/comments`;
